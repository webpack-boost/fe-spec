...
```shell
$ npm install eslint-plugin-lok eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['eslint-plugin-lok'],
  rules: {
    'eslint-plugin-lok/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:eslint-plugin-lok/recommended',
};
```
